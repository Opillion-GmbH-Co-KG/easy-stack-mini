...
ADD .docker/dev/mysql/init-raw.sql /etc/mysql/init-raw.sql
ADD .docker/dev/mysql/entrypoint.sh /etc/mysql/entrypoint.sh
ADD .docker/dev/mysql/my.cnf /etc/mysql/my.cnf
